...
class UserController extends Controller
{
  ...
  public function addProfilePhoto(Request $request) {
    ...
    try {
      ...
      if ( $request->file('userfile1') ) {
        $dest_path = base_path('/uploads/uploads_photo/');
        ...
        $user->photo_url = 'uploads/uploads_photo/'.$imageName;
        $user->save();
  ...
  public function sendVerifyEmail(Request $request) {
    ...
    try {
      ...
      $file = file_get_contents( base_path('/') . '/NEW_verifycode.html');
...
dd($response);
    ...
    try {
      ...
      if ( $request->file('userfile1') ) {
        ...
        if (is_null($record)) {
          ...
          $record->photo_url = 'uploads/equip/'.$photo_url;
  ...
  public function frmSendLink(Request $request) {
    return view('pages.users.sendlink');
  }
  ...
  public function sendLink(Request $request) {
    ...
    try {
      ...
      if (is_null($user)) {
        ...
        $ret['link'] = route('api.reset_pass', $hash_token);
        $link="<a href='".route('api.reset_pass', $hash_token)."'>Click To Reset password</a>";
        $to = $receiver_email;
  ...
  public function frmResetPass($token) {
    ...
    return view('pages.users.resetpass', $data);
  }
  public function resetPass(Request $request) {
    ...
    return view('pages.users.resetpass_result', $ret);
  }

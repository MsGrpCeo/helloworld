...
<script src="{{ url('public/assets/js/custom/utilities/modals/new-target.js') }}"></script>
<script src="{{ url('public/assets/js/custom/utilities/modals/users-search.js') }}"></script>

<script src="{{ url('public/js/pages.js').'?t='.time() }}"></script>

<script>
$(document).ready(function() {
  // $('#chk_hide_modal_label').click(function() {
  //   // console.log($('#chk_hide_modal_check').prop('checked'));
  //   localStorage.setItem("show-modal-onboard", !$('#chk_hide_modal_check').prop('checked')); 
  // });
  // // $('#chk_hide_modal_check').change(function() {
  // //   console.log($('#chk_hide_modal_check').prop('checked'));
  // // });

  // var onboard = localStorage.getItem("show-modal-onboard"); 
